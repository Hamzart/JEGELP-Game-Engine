...
public class Input {
    ...
    private static Vector2 oldMousePosition =new Vector2(Mouse.getX(),Mouse.getY());
    public static final int NUM_KEYCODES = 256;
    public static final int NUM_MOUSE = 6;
    ...
    private static boolean[] lastMouse = new boolean[NUM_MOUSE];

    public static void update()
    {
        if(oldMousePosition.IsDifferent(GetMousePosition()))
        {
            isMouseMoving = true;
